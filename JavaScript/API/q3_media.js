import { escreva, pergunta,get_number } from "./Funções_API/io.js"
...
function main(){
    ...
    //Apresentação 
        ...
        escreva(mensagem)
        escreva(`  ***Digite "Sexo !== M/F" para finalizar***\n`)
    ...
    //Saída
      ...
      mensagem = `
       =================================================
        ...
        --> Performance dos Homens: ${(media_Homens * 10).toFixed(1)}%
        --> Performance das Mulheres: ${(media_Mulheres * 10).toFixed(1)}%
        --> Desempenho dos Homens: ${calcular_desempenho(media_Homens)}
        --> Desempenho das Mulheres: ${calcular_desempenho(media_Mulheres)}
        --> Desempenho da Turma: ${calcular_desempenho(media_Geral)}
      =================================================
